...
export const styles = StyleSheet.create({
  ...
  candidateAdd: { width: 36, height: 36, borderRadius: 18, backgroundColor: '#12C170', alignItems: 'center', justifyContent: 'center', shadowColor: '#0B8F52', shadowOpacity: 0.18, shadowRadius: 5, shadowOffset: { width: 0, height: 2 }, elevation: 2 },
