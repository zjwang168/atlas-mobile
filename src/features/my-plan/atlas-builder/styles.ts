...
export const styles = StyleSheet.create({
  ...
  candidateMarker: { width: 32, height: 32, borderRadius: 16, backgroundColor: '#12C170', alignItems: 'center', justifyContent: 'center' },
  ...
  candidateName: { color: '#1A1A1A', fontSize: 14, lineHeight: 18, fontWeight: '700' },
  candidateAddress: { color: '#638078', fontSize: 11, lineHeight: 15, marginTop: 1 },
  candidateActions: { flexDirection: 'row', alignItems: 'center', gap: 5, flexShrink: 0 },
  candidateActionClip: { height: 36, overflow: 'hidden' },
  candidateAdd: { width: 92, height: 36, borderRadius: 18, backgroundColor: '#12C170', alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 4, shadowColor: '#0B8F52', shadowOpacity: 0.18, shadowRadius: 5, shadowOffset: { width: 0, height: 2 }, elevation: 2 },
  candidateAddText: { color: '#FFFFFF', fontSize: 12, fontWeight: '800' },
  candidateSave: { width: 58, height: 36, borderRadius: 18, backgroundColor: '#E8F5F0', borderWidth: StyleSheet.hairlineWidth, borderColor: '#BDE4D2', alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 3 },
  candidateSaveText: { color: '#155E46', fontSize: 11, fontWeight: '800' },
  candidateAsk: { width: 102, height: 36, borderRadius: 18, backgroundColor: '#12C170', alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 3 },
  candidateAskText: { color: '#FFFFFF', fontSize: 10, fontWeight: '800' },
  candidateFinish: { width: 36, height: 36, borderRadius: 18, backgroundColor: '#155E46', alignItems: 'center', justifyContent: 'center', shadowColor: '#155E46', shadowOpacity: 0.18, shadowRadius: 5, shadowOffset: { width: 0, height: 2 }, elevation: 2 },
  candidateFinishHit: { width: 36, height: 36, alignItems: 'center', justifyContent: 'center' },
  ...
  candidateAddedText: { color: '#12C170', fontSize: 11, fontWeight: '700' },
