...
export const styles = StyleSheet.create({
  ...
  headerRight: { flexShrink: 0, flexDirection: 'row', alignItems: 'center', gap: 8, maxWidth: '68%' },
  ...
  headerRouteButton: { flexShrink: 0, minHeight: 36, paddingHorizontal: 10, borderRadius: 10, backgroundColor: '#F4F4F5', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6 },
  headerRouteButtonDisabled: { opacity: 0.58 },
  headerRouteButtonText: { color: '#303033', fontSize: 13, fontWeight: '600' },
