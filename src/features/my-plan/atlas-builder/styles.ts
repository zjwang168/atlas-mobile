...
export const styles = StyleSheet.create({
  ...
  candidateFinish: { width: 42, height: 42, borderRadius: 21, position: 'absolute', right: 0, top: 2, alignItems: 'center', justifyContent: 'center', shadowColor: '#12C170', shadowOpacity: 0.2, shadowRadius: 6, shadowOffset: { width: 0, height: 2 }, elevation: 2 },
  ...
  candidateEmptyTitle: { color: '#697A76', fontSize: 12, lineHeight: 17, fontWeight: '700', paddingHorizontal: 20, textAlign: 'center' },
