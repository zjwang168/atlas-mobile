    ...
    <View style={styles.root}>
      <View style={styles.header}>
        ...
        <View style={styles.headerRight}>
          ...
          {atlasId ? <TouchableOpacity accessibilityLabel={route ? 'Hide route' : 'Show route'} disabled={generatingRoute} onPress={() => { void generateRoute(); }} style={[styles.headerRouteButton, generatingRoute && styles.headerRouteButtonDisabled]}>{generatingRoute ? <ActivityIndicator size="small" color="#303033" /> : <Ionicons name={route ? 'map' : 'map-outline'} size={18} color="#303033" />}<Text numberOfLines={1} style={styles.headerRouteButtonText}>{route ? 'Hide route' : 'Show route'}</Text></TouchableOpacity> : null}
